...
│   └── main.${hasReact ? 'jsx' : 'js'}  # Application entry point
├── public/            # Static assets
├── dist/             # Build output
├── package.json      # Dependencies and scripts
${hasVite ? '├── vite.config.js   # Vite configuration' : '├── webpack.config.js # Webpack configuration'}
${project.files.some(f => f.content.includes('@shopify/polaris')) ? '├── polaris.css      # Polaris styles' : ''}
└── README.md         # This file
\`\`\`
