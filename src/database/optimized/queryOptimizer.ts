  ...
  async executeQuery<T = any>(
    ...
    try {
      ...
      if (executionTime > this.config.monitoring.slowQueryThreshold) {
        this.trackSlowQuery(optimizationInfo || { query, parameters, planId: queryId, estimatedCost: 0, executionTime, indexes: [], optimization: { addedIndexes: [], rewrittenQuery: query, optimizations: [] } } as QueryPlan)
      }
